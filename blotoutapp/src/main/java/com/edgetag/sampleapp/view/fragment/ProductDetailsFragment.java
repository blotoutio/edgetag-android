...
import com.edgetag.sampleapp.util.ColorGenerator;
...
import com.edgetag.sampleapp.view.adapter.SimilarProductsPagerAdapter;
import com.edgetag.sampleapp.view.customview.ClickableViewPager;
import com.edgetag.sampleapp.view.customview.ClickableViewPager.OnItemClickListener;
import com.edgetag.sampleapp.view.customview.LabelView;
import com.edgetag.sampleapp.view.customview.TextDrawable;
import com.edgetag.sampleapp.view.customview.TextDrawable.IBuilder;
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (isFromCart) {
                            ...
                            EdgeTag.INSTANCE.tag("itemData", null, null, new CompletionHandler() {
                                @Override
                            ...
                            if (CenterRepository.getCenterRepository()
                                ...
                                eventInfo.put("item quanitity",tempObj.getQuantity());
